...
(if people-mode-map ()
  ...
  ; (define-key  people-mode-map "o" (function (lambda () (interactive) (people-goto-hit t))))
  (define-key  people-mode-map "?" 'people-describe-hit-briefly)
  (define-key  people-mode-map "s" 'people-show-hit)
  (define-key  people-mode-map "e" (function (lambda () (interactive)
  ...
  (define-key  people-mode-map ""
    (function (lambda (n) (interactive "nprune to depth: ")
